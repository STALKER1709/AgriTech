...
return [
    ...
    /*
    |--------------------------------------------------------------------------
    | Lignes de langue de la validation
    |--------------------------------------------------------------------------
    |
    | Ces messages sont affichés à l'utilisateur final : ils sont donc rédigés
    | en français. Les noms d'attributs traduits se trouvent à la clé
    ...
    */
    ...
    'contains' => 'Il manque une valeur dans le champ :attribute.',
    ...
    |--------------------------------------------------------------------------
    |
    | Les messages propres à un couple attribut/règle se déclarent ici. Ils sont
    | prioritaires sur les messages génériques ci-dessus.
    |
    */

    'custom' => [
        'phone' => [
            'regex' => 'Le numéro de téléphone doit être un numéro camerounais valide (ex. : 6XX XX XX XX).',
        ],
    ],
    ...
    |--------------------------------------------------------------------------
    |
    | Remplace le nom technique du champ par un libellé lisible dans les
    | messages d'erreur (« Le champ adresse e-mail est obligatoire. »).
    |
    */
