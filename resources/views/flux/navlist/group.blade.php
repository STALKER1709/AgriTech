...
>
    <button
        type="button"
        class="group/disclosure-button mb-[2px] flex h-10 w-full items-center rounded-lg text-stitch-muted hover:bg-stitch-high/60 hover:text-stitch-ink lg:h-8"
    >
        <div class="ps-3 pe-4">
    ...
    <div class="relative hidden space-y-[2px] ps-7 data-open:block" @if ($expanded === true) data-open @endif>
        <div class="absolute inset-y-[3px] start-0 ms-4 w-px bg-stitch-high"></div>
...
<div {{ $attributes->class('block space-y-[2px]') }}>
    <div class="px-1 py-2">
        <div class="text-xs leading-none text-stitch-muted/70">{{ $heading }}</div>
    </div>
